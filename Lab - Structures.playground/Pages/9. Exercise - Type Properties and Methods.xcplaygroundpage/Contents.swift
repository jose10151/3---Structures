...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Jose", email: "Jose2006@gmail.com", age: 10)
    
    
    
    static func logIn(p1:User)
    {
        
        currentUser = p1
        print("\(p1) has logged in!")
    }
}

print(User.currentUser.userName)
var newUser = User(userName: "ANTIGUA", email: "Catlhater@gmail.com", age: 20)
User.logIn(p1: newUser )
print(User.currentUser.userName)
